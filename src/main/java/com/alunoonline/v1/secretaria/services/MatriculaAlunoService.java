...
import com.alunoonline.v1.secretaria.models.DTOS.DisciplinasAlunoDto;
...
import com.alunoonline.v1.secretaria.repositories.MatriculaAlunoRepository;
    ...
    public void updateStatusToBreak(Long matriculaAlunoId) {
        ...
        if (matriculaAlunoToUpdate.isPresent()) {
            ...
            if (currentStatus.equals("MATRICULADO")) {
                ...
                throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"Só pode trancar uma matrícula com o status MATRICULADO");
            }
        } else {
